...
const CreateQuestionForm = ({setNeedUpdate}) => {
    ...
    return(<details>
        ...
        <form className={"m-2 "}>
            ...
            <div >Enter question:<input className={"border border-gray-800 rounded my-2"} type={"text"} onChange={e=>setQuestionData(prev=>({...prev, question:e.target.value}))} value={questionData.question}/></div>
